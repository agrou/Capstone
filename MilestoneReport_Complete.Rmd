...
`sampleCorpus` has the three samples of each text corpus/sources together which corresponds to 10% of the original text corpus. The sample is split into a Training set (80%) and a Test set (20%). 
```{r}
set.seed(2017)
Train <- sampleCorpus %>% sample_frac(0.8)
Test  <- anti_join(sampleCorpus, Train, by = c("id", "text"))
```
