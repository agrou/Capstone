...
As the data was relatively large, a 10% random sample of the following datasets was used: `en_US.blog.txt`, `en_US.twitter.txt` and `en_US.news.txt`. These samples were combined and **cleaned** for analysis (e.g. removal of HTML tags, punctuation, bullet points and non-common characters). 
