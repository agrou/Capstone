...
We should be able to get good estimations with a 3-grams model. 
...
Building the model on a "train" set and then testing it on a "test" set. Adding more or less parameters should tells us about the model's accuracy. 
